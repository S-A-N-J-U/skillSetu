...
function Footer() {
    return (
        <footer className="relative mt-10 bg-white border-t border-gray-200 pt-16 pb-12 font-sans">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">


                    <div className="lg:col-span-2 flex flex-col justify-between pr-0 lg:pr-8">
                        <div>
                            <div className="inline-flex items-center mb-4">
                                <Logo width="120px" />
                            </div>
                            <p className="text-sm text-gray-500 leading-relaxed max-w-sm mb-6">
                                Empowering learning and skill development. Connect, grow, and achieve your career goals with Skill Setu.
                            </p>
                        </div>


                        <div className="flex space-x-4 mb-6 md:mb-0 text-gray-400">
                        ...
                        <ul className="space-y-3">
                            {['Features', 'Pricing', 'Affiliate Program', 'Press Kit'].map((item) => (
                                <li key={item}>
                                    <Link
                                        to="/"
                                        className="text-sm font-normal text-gray-600 hover:text-indigo-600 transition-colors duration-200"
                                    >
                                        {item}
                                    </Link>
                                </li>
                ...
                <div className="mt-12 pt-8 border-t border-gray-100 flex flex-col sm:flex-row justify-between items-center">
                    <p className="text-xs text-gray-400">
                        &copy; {new Date().getFullYear()} Skill Setu. All rights reserved.
                    </p>
                    <div className="mt-4 sm:mt-0 text-xs text-gray-400">
                        Designed with simplicity & care.
                    </div>
                </div>
            </div>
        </footer>
